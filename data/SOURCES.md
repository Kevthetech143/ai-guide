# ai-guide-001a sources (checked 2026-09-11)

- ChatGPT (chatgpt): https://openai.com/chatgpt/pricing
- Claude (claude): https://www.anthropic.com/pricing
- Gemini (gemini): https://one.google.com/intl/en_sg/about/google-ai-plans/
- Grok (grok): https://x.ai/grok
- Perplexity (perplexity): https://www.perplexity.ai/pro
- Llama (llama): https://ai.meta.com/blog/meta-llama-3-1-ai-responsibility/
- Mistral (mistral): https://mistral.ai/products/vibe/
- Qwen (qwen): https://qwen.ai/
- Midjourney (midjourney): https://docs.midjourney.com/hc/en-us/articles/27870484040333-Comparing-Midjourney-Plans
- Stable Diffusion (stable-diffusion): https://stability.ai/news-updates/introducing-stable-diffusion-3-5
- Flux (flux): https://bfl.ai
- ElevenLabs (elevenlabs): https://elevenlabs.io/pricing
- Suno (suno): https://suno.com/pricing
- Runway (runway): https://runway.com/pricing
- Cursor (cursor): https://cursor.com/pricing

# ai-guide-003a sources (checked 2026-09-11)

- Whisper (whisper): https://github.com/openai/whisper
- Sora (sora): https://sora.com
- Veo (veo): https://deepmind.google
- Pika (pika): https://pika.art
- Kling (kling): https://kling.kuaishou.com
...
- Claude Code (claude-code): https://www.anthropic.com/pricing
- Replit (replit): https://replit.com
- Google AI Mode (google-ai-mode): https://www.google.com/aimode
